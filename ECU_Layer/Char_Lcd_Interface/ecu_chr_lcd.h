...
void lcd_8bit_send_number(const chr_lcd_8bit_t *lcd, uint32 number);
void lcd_8bit_send_number_pos(const chr_lcd_8bit_t *lcd, uint8 row, uint8 column, uint32 number);
